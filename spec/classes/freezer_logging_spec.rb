...
describe 'freezer::logging' do
  ...
  let :log_params do
    {
     ...
     :log_dir => '/var/log',
     :log_file => '/var/tmp/freezer_random.log',
     :debug => true,
    }
  end
  ...
  shared_examples 'basic default logging settings' do
    it 'configures freezer logging settings with default values' do
      is_expected.to contain_oslo__log('freezer_config').with(
        ...
        :log_file            => '/var/log/freezer/freezer.log',
  ...
  shared_examples 'basic non-default logging settings' do
    it 'configures freezer logging settings with non-default values' do
      is_expected.to contain_oslo__log('freezer_config').with(
        :use_syslog          => true,
        :use_json            => true,
        :use_journal         => true,
  ...
  shared_examples_for 'logging params unset' do
   [ :logging_context_format_string, :logging_default_format_string,
     ...
     :log_date_format, ].each { |param|
        it { is_expected.to contain_oslo__log('freezer_config').with("#{param}" => '<SERVICE DEFAULT>') }
      }
  end
